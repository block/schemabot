...
.av{position:absolute;left:-56px;top:0;width:40px;height:40px;border-radius:50%;object-fit:cover;background:#eee}
.av.h{background:linear-gradient(135deg,#6e40c9,#2da44e)}
...
PANELS = {
    "checks": (
        '<div class="box"><div class="row ok"><span class="i ok"></span>All checks have passed'
        '<span class="pill">3 successful checks</span></div>'
        '<div class="row"><span class="i ok"></span><b>ci / test</b> — Successful in 4m<span class="pill">Details</span></div>'
        '<div class="row"><span class="i ok"></span><b>SchemaBot (staging)</b> — Successful in 6m<span class="pill">Details</span></div>'
        '<div class="row"><span class="i ok"></span><b>SchemaBot (production)</b> — Successful in 2h 14m<span class="pill">Details</span></div>'
        '<div class="row"><span class="i ok"></span>This branch has no conflicts with the base branch'
        '<span class="pill">Merging can be performed automatically.</span></div>'
        '<div class="row"><span class="btn">Merge pull request</span></div></div>'
    ),
    "merged": (
