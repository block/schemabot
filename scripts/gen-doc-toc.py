...
def slugify(text: str) -> str:
    ...
    # replace each whitespace character with `-`. Runs are not collapsed:
    # "CLI / PR" leaves two spaces once the slash is dropped, and GitHub
    # anchors that as "cli--pr". Underscores are preserved because GitHub
    # treats them as word characters in heading anchors.
