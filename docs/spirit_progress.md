...
- [API and CLI layers](#api-and-cli-layers)
  - [API (`pkg/api/progress_handlers.go`)](#api-pkgapiprogresshandlersgo)
  - [CLI/TUI (`pkg/cmd/commands/watch_tui.go`)](#clitui-pkgcmdcommandswatchtuigo)
