...
- [Probes: liveness vs readiness](#probes-liveness-vs-readiness)
- [What happens to an in-flight apply](#what-happens-to-an-in-flight-apply)
- [Failure taxonomy in the drive loops](#failure-taxonomy-in-the-drive-loops)
- [The unsupervised window](#the-unsupervised-window)
- [Split-brain protection on recovery](#split-brain-protection-on-recovery)
