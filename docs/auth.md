...
Start with where the server runs, then choose the access method you need.
Follow that setup section and check your access; the later sections explain
troubleshooting and proxy details when you need them.
