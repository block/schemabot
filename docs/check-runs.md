...
`No schema changes detected` aggregate so GitHub can satisfy the required check
...
or `vschema.json` files, SchemaBot publishes `No schema changes detected` instead
