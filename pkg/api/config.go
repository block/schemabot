...
type ServerConfig struct {
	...
	// key, crashlooping the server). Validate() folds it into Drivers when the
	// new key is unset and logs a deprecation warning. Remove once deployed
	// configs no longer set this key.
	//
