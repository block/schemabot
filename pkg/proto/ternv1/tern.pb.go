...
type StorageSchemaApplyRequest struct {
	...
	// converge.
	SchemaFiles map[string]string `protobuf:"bytes,3,rep,name=schema_files,json=schemaFiles,proto3" json:"schema_files,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	SchemaSource  string `protobuf:"bytes,4,opt,name=schema_source,json=schemaSource,proto3" json:"schema_source,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_tern_proto_rawDesc = "" +
	...
	"\x06report\x18\x01 \x01(\v2\x1c.tern.v1.StorageSchemaReportR\x06report\"\x9d\x02\n" +
	"\x19StorageSchemaApplyRequest\x12+\n" +
	"\x11allow_destructive\x18\x01 \x01(\bR\x10allowDestructive\x12\x16\n" +
	"\x06caller\x18\x02 \x01(\tR\x06caller\x12V\n" +
	"\fschema_files\x18\x03 \x03(\v23.tern.v1.StorageSchemaApplyRequest.SchemaFilesEntryR\vschemaFiles\x12#\n" +
	"\rschema_source\x18\x04 \x01(\tR\fschemaSource\x1a>\n" +
	"\x10SchemaFilesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
...
var file_tern_proto_goTypes = []any{
	...
	(*StorageSchemaPlanRequest)(nil),   // 47: tern.v1.StorageSchemaPlanRequest
	(*StorageSchemaStatement)(nil),     // 48: tern.v1.StorageSchemaStatement
	(*StorageSchemaReport)(nil),        // 49: tern.v1.StorageSchemaReport
	(*StorageSchemaPlanResponse)(nil),  // 50: tern.v1.StorageSchemaPlanResponse
...
var file_tern_proto_depIdxs = []int32{
	...
	65, // 39: tern.v1.StorageSchemaPlanRequest.schema_files:type_name -> tern.v1.StorageSchemaPlanRequest.SchemaFilesEntry
