...
const (
	...
	Tern_StorageSchemaDiff_FullMethodName  = "/tern.v1.Tern/StorageSchemaDiff"
...
type TernClient interface {
	...
	// StorageSchemaDiff reports the DDL outstanding between the embedded storage
	...
	StorageSchemaDiff(ctx context.Context, in *StorageSchemaDiffRequest, opts ...grpc.CallOption) (*StorageSchemaDiffResponse, error)
...
func (c *ternClient) StorageSchemaDiff(ctx context.Context, in *StorageSchemaDiffRequest, opts ...grpc.CallOption) (*StorageSchemaDiffResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StorageSchemaDiffResponse)
	err := c.cc.Invoke(ctx, Tern_StorageSchemaDiff_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TernServer interface {
	...
	// against, not what this storage converged to, and those diverge exactly when
	// a deploy has failed to converge.
	StorageSchemaDiff(context.Context, *StorageSchemaDiffRequest) (*StorageSchemaDiffResponse, error)
	// StorageSchemaApply converges the serving instance's own storage schema and
	// reports what it found and what it left behind.
	//
	// The convergence is the serving binary's startup bootstrap, called
...
func (UnimplementedTernServer) StorageSchemaDiff(context.Context, *StorageSchemaDiffRequest) (*StorageSchemaDiffResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StorageSchemaDiff not implemented")
}
...
func _Tern_StorageSchemaDiff_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StorageSchemaDiffRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TernServer).StorageSchemaDiff(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Tern_StorageSchemaDiff_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TernServer).StorageSchemaDiff(ctx, req.(*StorageSchemaDiffRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Tern_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StorageSchemaDiff",
			Handler:    _Tern_StorageSchemaDiff_Handler,
		},
		{
