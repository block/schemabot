...
const (
	...
	PreviewCommentStrataPlanVSchemaRefresh     PreviewType = "comment_strata_plan_vschema_refresh"     // Strata plan whose VSchema work only refreshes DDL-derived entries
