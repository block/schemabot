...
func previewCommentAllOutput() {
	sections := []struct {
		...
		{"TARGETS CONVERGING", func() { fmt.Print(webhooktemplates.PreviewCommentPlanTargetsConverging()) }},
		{"TARGETS DIVERGING", func() { fmt.Print(webhooktemplates.PreviewCommentPlanTargetsDiverging()) }},
		{"TARGETS LARGE FLEET", func() { fmt.Print(webhooktemplates.PreviewCommentPlanTargetsLargeFleet()) }},
