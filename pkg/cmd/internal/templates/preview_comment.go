...
func previewCommentPlanAllOutput() {
	sections := []struct {
		...
		{"STRATA PLAN: VSCHEMA REFRESHED FROM DDL", func() { fmt.Print(webhooktemplates.PreviewCommentStrataPlanVSchemaRefresh()) }},
...
func previewCLIPlanAllOutput() {
	sections := []struct {
		...
		{"PLAN (STRATA, VSCHEMA REFRESHED FROM DDL)", previewStrataPlanVSchemaRefreshOutput},
