...
| `DatabaseNotFoundError` (`RepositoryNotAccepted`) | "Database Not Available to This Repository" | Add the repository to the database's `allowed_repos` if it should manage the database |
